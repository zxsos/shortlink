...
public class UserTableShardingTest {
    public static String SQL = "CREATE TABLE `t_user_%d`  (\n" +
            ...
            "  UNIQUE INDEX `idx_unique_username`(`username` ASC) USING BTREE COMMENT '用户名唯一'\n" +
            ") ENGINE = InnoDB AUTO_INCREMENT = 1881655258558922754 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;"
;
